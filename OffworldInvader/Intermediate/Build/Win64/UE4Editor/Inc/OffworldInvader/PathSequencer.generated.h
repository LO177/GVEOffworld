...
#ifdef OFFWORLDINVADER_PathSequencer_generated_h
#error "PathSequencer.generated.h already included, missing '#pragma once' in PathSequencer.h"
#endif
...
public: \
	DECLARE_CLASS(APathSequencer, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/OffworldInvader"), NO_API) \
...
#define OffworldInvader_Source_OffworldInvader_PathSequencer_h_42_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, APathSequencer); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(APathSequencer); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API APathSequencer(APathSequencer&&); \
	NO_API APathSequencer(const APathSequencer&); \
public:
...
template<> OFFWORLDINVADER_API UClass* StaticClass<class APathSequencer>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID OffworldInvader_Source_OffworldInvader_PathSequencer_h
